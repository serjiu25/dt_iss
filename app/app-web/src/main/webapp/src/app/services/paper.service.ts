...
export class PaperService {
  ...
  createPaper(paper: Paper): Observable<Paper> {// maybe change with sub fields instead of object
    const filterPaper: Paper = {
      ...
      topics: paper.topics,
      other_authors: paper.otherAuthors
    };
    return this.httpClient.post<Paper>(this.papersUrl, filterPaper);
  }
  ...
  uploadPaper(paperId: number, abstract: string, file: File): Observable<any> {
